...
class CColourDetector : public CImageProcessorNode
{
    ...
    protected:
        /**
         * @brief ProcessImage (override) - Stores latest image for processing
         * when AprilTag detections arrive.
    ...
    private:
        /**
         * @brief Processes AprilTag detections and analyses colour around each
         * tag.
        ...
        /**
         * @brief Examines pixels surrounding an AprilTag to determine damage
         * type.
        ...
        /**
         * @brief Defines four sampling regions (above, below, left, right)
         * around tag.
         * @param aTagCenterX X coordinate of tag center [pixels]
         * @param aTagCenterY Y coordinate of tag center [pixels]
         ...
         */
        std::vector<cv::Rect>
        ExtractSamplingRegions(int aTagCenterX, int aTagCenterY, int aTagSize,
                               int aImageWidth, int aImageHeight);
        ...
        /**
         * @brief Draw four sampling rectangles around tag and colour-code
         * borders by class
         ...
         */
        void DrawSamplingRegions(cv::Mat &aImage, int aTagCenterX,
         ...
         */
        void OverlayHSVStatistics(cv::Mat &aImage, const cv::Rect &aRegion,
        ...
        rclcpp::Subscription<apriltag_msgs::msg::AprilTagDetectionArray>::
            SharedPtr mpTagSubscriber;
        ///< Subscribes to AprilTag detections; owned by this node, created in
        ///< ctor

        rclcpp::Publisher<std_msgs::msg::String>::SharedPtr mpDamagePublisher;
        ///< Publishes damage reports as JSON strings; owned by this node,
        ///< created in ctor
        ...
        const int kMinPixelCount = 50; ///< Minimum number of colored pixels
                                       ///< required for detection [pixels]
};
