...
public:
    ...
    nav_msgs::msg::Path planExplorationPath(const nav_msgs::msg::OccupancyGrid& map,
                                            const geometry_msgs::msg::Pose& current_pose);
    bool isExplorationComplete() const { return is_finished_exploring_; }
    int getNoFrontiersCounter() const { return no_frontiers_found_counter_; }
...
private:
    ...
    rclcpp::Subscription<std_msgs::msg::Bool>::SharedPtr exploration_status_sub_;
    ...
    std::vector<FrontierSearch::Frontier> getTopFrontiers(
