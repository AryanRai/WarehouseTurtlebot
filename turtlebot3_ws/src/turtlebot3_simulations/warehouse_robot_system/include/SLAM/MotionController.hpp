...
class MotionController : public rclcpp::Node
{
    public:
        ...
        computeVelocityCommand(const geometry_msgs::msg::Pose &current_pose,
    ...
    private:
        ...
        findLookahead(const geometry_msgs::msg::Pose &pose,
                      int nearest_waypoint_index) const;
        geometry_msgs::msg::Point getGoal() const;
        double getDistanceToWaypoint(const geometry_msgs::msg::Pose &pose,
                                     int index) const;
