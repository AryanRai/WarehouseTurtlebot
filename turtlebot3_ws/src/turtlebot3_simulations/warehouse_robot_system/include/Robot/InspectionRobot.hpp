 ...
 *
 * Inherits common functionality from WarehouseRobot and adds
...
class InspectionRobot : public WarehouseRobot
{
    public:
         ...
         */
        std::vector<InspectionData::DamageSite> getSites() const
        {
            return damage_sites_;
        }
         ...
         */
        void
        addInspectionRequest(const InspectionData::InspectionRequest &request);
         ...
         */
        std::vector<InspectionData::InspectionRequest>
        getInspectionQueue() const
        {
        ...
        generatePatrolPoints(const nav_msgs::msg::OccupancyGrid &map);
    ...
    private:
         ...
         */
        bool isValidPatrolPoint(const geometry_msgs::msg::Point &point,
        ...
        createSiteMarker(const InspectionData::DamageSite &site, int id);
         ...
         */
        void
        onPointClicked(const geometry_msgs::msg::PointStamped::SharedPtr msg);
