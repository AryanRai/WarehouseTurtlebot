...
{
    public:
        // DamageSite - Represents a discovered damage location marked by
        // AprilTag
        struct DamageSite
        {
            ...
            std::chrono::system_clock::time_point
                discovered_time; // When it was found

            DamageSite() : apriltag_id(-1) {}

            DamageSite(const std::string &n, int tag_id,
        ...
        struct InspectionRecord
        {
            ...
            InspectionRecord()
                : apriltag_id(-1), distance_traveled(0.0),
