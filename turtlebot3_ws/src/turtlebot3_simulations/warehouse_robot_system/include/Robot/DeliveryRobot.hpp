 ...
 *
 * Inherits common functionality from WarehouseRobot and adds delivery-specific
 * features:
...
class DeliveryRobot : public WarehouseRobot
{
    public:
         ...
         */
        std::vector<DeliveryData::DeliveryZone> getZones() const
        {
            return zones_;
        }
         ...
         */
        std::vector<DeliveryData::DeliveryRequest> getDeliveryQueue() const
        {
