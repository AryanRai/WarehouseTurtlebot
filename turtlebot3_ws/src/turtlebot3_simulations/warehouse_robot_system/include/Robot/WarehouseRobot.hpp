...
/**
 * @brief Base class for warehouse robots with common navigation and
...
class WarehouseRobot
{
    public:
         ...
         * @param use_tsp True to use TSP optimization, false for ordered
         * sequence
         */
        void setOptimizationMode(bool use_tsp)
        {
            use_tsp_optimization_ = use_tsp;
        }
    ...
    protected:
        ...
        std::vector<int> simulatedAnnealing(
            ...
            int start_idx, double initial_temp = 10000.0,
        ...
        /**
         * @brief Precise docking behavior for final approach to target
         * (zone/site)
         * @param current_pose Current robot pose
         ...
         */
        void preciseTargetDocking(const geometry_msgs::msg::Pose &current_pose,
         ...
         * @param threshold Battery percentage threshold for emergency return
         * (-1 to disable)
         */
