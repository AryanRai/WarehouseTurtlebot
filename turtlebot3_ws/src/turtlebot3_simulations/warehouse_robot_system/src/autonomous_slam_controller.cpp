...
void AutonomousSlamController::handlePlanningPath() {
    ...
    FrontierSearch::Frontier best_frontier = selectBestFrontier(detected_frontiers_);
...
FrontierSearch::Frontier AutonomousSlamController::selectBestFrontier(const std::vector<FrontierSearch::Frontier>& frontiers) {
    if (frontiers.empty()) {
    ...
    std::vector<FrontierSearch::Frontier> sorted_frontiers = unvisited_frontiers;
