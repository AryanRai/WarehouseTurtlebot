...
//
// Description: Implementation of base image processor node for camera image
// processing.
    ...
    const sensor_msgs::msg::Image::SharedPtr aMsg)
{
    ...
    {
        cvPointer =
            cv_bridge::toCvCopy(aMsg, sensor_msgs::image_encodings::BGR8);
    }
...
bool CImageProcessorNode::ValidateImage(const cv::Mat &aImage) const
{
    ...
    {
        RCLCPP_WARN(this->get_logger(), "Image dimensions too small: %dx%d",
